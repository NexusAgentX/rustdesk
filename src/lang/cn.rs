...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Changing session control", "正在切换会话控制权"),
        ("AI controls this session", "AI 正在控制此会话"),
        ("AI joined; you control this session", "AI 已加入；当前由你控制"),
        ("Take control", "由我接管"),
        ("Approve AI control", "批准 AI 接管"),
        ("Require human approval for AI control", "AI 接管需要人类批准"),
        ("Enable MCP service", "启用 MCP 服务"),
        ("Local HTTP port", "本地 HTTP 端口"),
        ("Copy MCP token", "复制 MCP 令牌"),
        ("Reset MCP token", "重置 MCP 令牌"),
        ("Copy AI connection configuration", "复制 AI 连接配置"),
        ("Connected agents", "已连接的 agent"),
        ("No agents connected", "暂无 agent 连接"),
        ("Connected at", "连接时间"),
        ("Last communication", "最近通信"),
        ("Port must be between 1 and 65535", "端口必须在 1～65535 之间"),
        ("MCP token reset; agents were disconnected", "MCP 令牌已重置，agent 已断开连接"),
        ("Start MCP before copying connection configuration", "请先启动 MCP，再复制连接配置"),
        ("Starting", "启动中"),
        ("Running", "运行中"),
        ("Stopped", "已停止"),
    ].iter().cloned().collect();
