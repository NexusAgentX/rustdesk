...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Changing session control", ""),
        ("AI controls this session", ""),
        ("AI joined; you control this session", ""),
        ("Take control", ""),
        ("Approve AI control", ""),
        ("Require human approval for AI control", ""),
        ("Enable MCP service", ""),
        ("Local HTTP port", ""),
        ("Copy MCP token", ""),
        ("Reset MCP token", ""),
        ("Copy AI connection configuration", ""),
        ("Connected agents", ""),
        ("No agents connected", ""),
        ("Connected at", ""),
        ("Last communication", ""),
        ("Port must be between 1 and 65535", ""),
        ("MCP token reset; agents were disconnected", ""),
        ("Start MCP before copying connection configuration", ""),
        ("Starting", ""),
        ("Running", ""),
        ("Stopped", ""),
    ].iter().cloned().collect();
