...
root=Path('/Users/laysath/Library/Caches/rustdesk-build/mobile-20260918/downloads/ios-runtime');root.mkdir(exist_ok=True)
metadata=plistlib.loads(Path('/System/Library/AssetsV2/com_apple_MobileAsset_iOSSimulatorRuntime/com_apple_MobileAsset_iOSSimulatorRuntime.xml').read_bytes())
asset=next(a for a in metadata['Assets'] if a['Build']=='24A434' and a['Architectures']==['arm64'])
