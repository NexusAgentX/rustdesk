...
export VCPKG_ROOT=/Users/laysath/Library/Caches/rustdesk-build/mobile-20260918/native-device
export VCPKG_DEFAULT_TRIPLET=arm64-ios
export VCPKG_TARGET_TRIPLET=arm64-ios
export SDKROOT="$(xcrun --sdk iphoneos --show-sdk-path)"
export IPHONEOS_DEPLOYMENT_TARGET=13.0
export LIBCLANG_PATH=/opt/homebrew/opt/llvm/lib
export BINDGEN_EXTRA_CLANG_ARGS="--target=arm64-apple-ios13.0 -isysroot $SDKROOT -isystem $(xcrun clang -print-resource-dir)/include"
export SODIUM_USE_PKG_CONFIG=1
export PKG_CONFIG_ALLOW_CROSS=1
export PKG_CONFIG_ALL_STATIC=1
export PKG_CONFIG_LIBDIR_aarch64_apple_ios=/Users/laysath/Library/Caches/rustdesk-build/mobile-20260918/libsodium-device/lib/pkgconfig
