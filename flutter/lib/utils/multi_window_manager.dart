...
class RustDeskMultiWindowManager {
  ...
  Future<void> closeAutomationSession(String kind, String requestId, String peerId) async {
    final windows = List<int>.from(kind == 'terminal' ? _terminalWindows : kind == 'file_transfer' ? _fileTransferWindows : kind == 'tcp_tunnel' ? _portForwardWindows : _remoteDesktopWindows);
    for (final windowId in windows) {
      try {
